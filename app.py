...
df = pd.read_csv("/Users/apple/Documents/Wearable/tableau_exports/weekly_nudges_llm.csv", parse_dates=["week"])
...
with tabs[0]:
    ...
    st.components.v1.html(
        """
        <iframe src="https://public.tableau.com/views/Cardinovascularhealthdashboard/Dashboard1?:language=en-US&publish=yes&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link"
